...
**Operator front door:** Grok Chief of Staff (company). Berk talks to Grok CoS; CoS routes work to Hermes **`bej`**. Personal calendar/digest → Grok CEO Assistant (not Hermes Employee 01).
...
| 04 | Architect + DevOps + Execution | `bej` | `bej` | P0 | architecture-review |
| 05 | Frontend UX + Full-stack | `bej` | `bej` | P1 | ux-design-review |
...
| 10 | Marketing + Social | `bej` | `bej` | P1 | marketing-social-content, social-content-calendar |
| 11 | Automation + Data | `bej` | `bej` | P0 | automation-data-pipeline |
| 12 | CFO + CTO | `bej` | `bej` | P1 | executive-review |

**Orchestrator:** `bej` profile, skill **`kanban-orchestrator`**, board **`berkode-ops`**. (Retired profiles `ops` / `social` — not used.)
